...
namespace Questeloper.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250201131656_HeroClassCorrections")]
    partial class HeroClassCorrections
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Questeloper.Domain.Entities.HeroClass", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Questeloper.Domain.Entities.Hero", b =>
                {
                    b.HasOne("Questeloper.Domain.Entities.HeroClass", "HeroClass")
                        .WithMany("Heroes")
